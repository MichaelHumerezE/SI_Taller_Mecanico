...
class OrdenController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('ordens.create', compact('mecanicos', 'servicios'));
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'fechai' => 'required',
            'mecanico' => 'required',
            'matricula' => 'required|exists:vehiculos,matricula',
            'servicios' => 'required',
        ]);
        ...
        $orden->mecanico_id = $request->mecanico;
        $orden->vehiculo_id = $vehiculo->id;
        //$orden->reserva_id = $reserva->id;
        $orden->save();
        $orden->servicios()->attach($request->servicios);
        /* if ($request->mecanico) {
    ...
    public function show(orden $orden)
    {
        ...
        return view('ordens.show', compact('orden', 'mecanicos', 'servicios'));
    }
    ...
    public function edit(orden $orden)
    {
        ...
        $servicios = DB::table('servicios')
            ->join('orden_servicio', 'servicios.id', '=', 'orden_servicio.servicio_id')
            ->where('orden_servicio.orden_id', $orden->id)
            ->select('servicios.*')
            ->get();
        return view('ordens.edit', compact('orden', 'ordenesRepuestos', 'vehiculo', 'cliente', 'servicios'));
    }
